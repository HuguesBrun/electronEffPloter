...
TFile *myFileA = new TFile("theEfficiencyPlots_data_All.root");
TFile *myFileB = new TFile("theEfficiencyPlots_data_RunAB.root");
TFile *myFileC = new TFile("theEfficiencyPlots_data_RunC.root");
TFile *myFileD = new TFile("theEfficiencyPlots_data_RunD.root");
...
drawMyPlot(TString nameCut, TString theText, TString title, float yMin, float yMax){
	...
	TGraphAsymmErrors *theGraph4 = (TGraphAsymmErrors*) myFileA->Get(nameCut);
    ...
    TGraphAsymmErrors *theGraph4B = (TGraphAsymmErrors*) myFileB->Get(nameCut);
    ...
    TGraphAsymmErrors *theGraph4C = (TGraphAsymmErrors*) myFileC->Get(nameCut);
    ...
    TGraphAsymmErrors *theGraph4D = (TGraphAsymmErrors*) myFileD->Get(nameCut);
 ...
 //   line->Draw("same");
	...
	c0->Print("compDATA/plot_"+nameCut+"MC.png");
